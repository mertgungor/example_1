...
(cl:in-package example1_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <zaman>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'zaman)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example1_pkg-msg:<zaman> is deprecated: use example1_pkg-msg:zaman instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <zaman>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example1_pkg-msg:stamp-val is deprecated.  Use example1_pkg-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <zaman>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example1_pkg-msg:data-val is deprecated.  Use example1_pkg-msg:data instead.")
  (data m))
