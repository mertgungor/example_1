...
(cl:defmethod cl:initialize-instance :after ((m <Dummy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Dummy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example1_pkg-msg:<Dummy> is deprecated: use example1_pkg-msg:Dummy instead.")))

(cl:ensure-generic-function 'n-val :lambda-list '(m))
(cl:defmethod n-val ((m <Dummy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example1_pkg-msg:n-val is deprecated.  Use example1_pkg-msg:n instead.")
  (n m))

(cl:ensure-generic-function 'arr-val :lambda-list '(m))
(cl:defmethod arr-val ((m <Dummy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example1_pkg-msg:arr-val is deprecated.  Use example1_pkg-msg:arr instead.")
  (arr m))
