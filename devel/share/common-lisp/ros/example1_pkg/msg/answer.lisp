...
(cl:defmethod cl:initialize-instance :after ((m <answer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'answer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example1_pkg-msg:<answer> is deprecated: use example1_pkg-msg:answer instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <answer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example1_pkg-msg:sum-val is deprecated.  Use example1_pkg-msg:sum instead.")
  (sum m))
